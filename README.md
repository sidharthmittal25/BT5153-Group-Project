...
7. Web Scraping (Field Partners) and Web Scraping (Interest Groups) contain the codes which we used to scrape the field partner and interest group information from the Kiva website.
